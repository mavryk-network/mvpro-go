...
type BigmapValue struct {
	...
	Meta      *BigmapMeta `json:"meta,omitempty"        mvpro:"-"`
	Key       MultiKey    `json:"key"                   mvpro:"-"`
	Value     any         `json:"value,omitempty"       mvpro:"-"`
	KeyPrim   *Prim       `json:"key_prim,omitempty"    mvpro:"key,hex"`
	ValuePrim *Prim       `json:"value_prim,omitempty"  mvpro:"value,hex"`
}
