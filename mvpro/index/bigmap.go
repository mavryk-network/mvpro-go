...
type Bigmap struct {
	...
	KeyType        Typedef   `json:"key_type"         mvpro:"-"`
	ValueType      Typedef   `json:"value_type"       mvpro:"-"`
	KeyTypePrim    Prim      `json:"key_type_prim"    mvpro:"key_type,hex"`
	ValueTypePrim  Prim      `json:"value_type_prim"  mvpro:"value_type,hex"`
}
