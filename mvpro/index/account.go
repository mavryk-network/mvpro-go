...
type Account struct {
	...
	CreatorId          uint64              `json:"creator_id,omitempty"  mvpro:"-"`
	...
	FrozenRewards      float64             `json:"frozen_rewards"         mvpro:"-"`
	...
	LifetimeRewards    float64             `json:"lifetime_rewards,omitempty" mvpro:"-"`
	PendingRewards     float64             `json:"pending_rewards,omitempty"  mvpro:"-"`
