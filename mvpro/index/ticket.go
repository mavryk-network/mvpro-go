...
type Ticket struct {
	Id           uint64    `json:"id"`
	Ticketer     Address   `json:"ticketer"`
	Type         Prim      `json:"type"            mvpro:"type,hex"`
	Content      Prim      `json:"content"         mvpro:"content,hex"`
...
type TicketBalance struct {
	Id           uint64    `json:"id"`
	TicketId     uint64    `json:"-"               mvpro:"ticket"`
	Ticketer     Address   `json:"ticketer"        mvpro:"-"`
	Type         Prim      `json:"type"            mvpro:"-"`
	Content      Prim      `json:"content"         mvpro:"-"`
	Hash         string    `json:"hash"            mvpro:"-"`
	Account      Address   `json:"account"`
...
type TicketEvent struct {
	...
	Content   Prim      `json:"content"     mvpro:"-"`
	Hash      string    `json:"hash"        mvpro:"-"`
	EventType string    `json:"event_type"  mvpro:"type"`
